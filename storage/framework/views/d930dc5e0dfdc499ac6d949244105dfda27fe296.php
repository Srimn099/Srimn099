...
<div class="card">
    ...
    <form action="signup" method="post" class="card-form">
        ...
        <div class="form mb-3">
            ...
            <input type="text" class="form-control rounded-0 border-0 ps-0 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="Masukkan nama" value="<?php echo e(old('name')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form mb-3">
            ...
            <input type="text" class="form-control rounded-0 border-0 ps-0 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" placeholder="Masukkan email" value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('templates/auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\b-log\resources\views/auth/signup.blade.php ENDPATH**/ ?>